...
(*"was before"* --> how the things *were before* the cloud computing)
...
<img height=420px width=747px src="http://users.metropolia.fi/~ollial/nodejs-2017/img/jelastic_main.png"></img>

---

# Jelastic, environment settings

<img height=420px width=747px src="http://users.metropolia.fi/~ollial/nodejs-2017/img/jelastic_env.png"></img>

---

# Jelastic, marketplace

<img height=420px width=747px src="http://users.metropolia.fi/~ollial/nodejs-2017/img/jelastic_marketplace.png"></img>

---


# Jelastic, warmup task

* Deploy PB2, a serverless Node.js server for socket connections from here: 
...
* Available [here](https://gist.github.com/OAlm/b49b8ab820163c128d9c9ceb065a6d09)
* Deadline on Friday 16:00 (but afternoon should be enough for this.)